#!/bin/bash
# BLACKEYE v1.1 is an upgrade from original Shymon Hasan Tool (https://github.com/Shymon-Hasan) by @Shymon-Hasan under GNU LICENSE 
...
# Credits (Copyright)
# Phishing Pages generated by Rafin (https://github.com/Shymon-Hasan):
# Instagram
...
╰━━━┻╯╱╰╯╰━━━┻╯╱╰┻╯╰╯╰╯\n"
\e[1;94m CODED BY:  @Shymon-Hasan\e[0m\n"
